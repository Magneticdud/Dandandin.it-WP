...
{
    /// <summary>
    /// Phone application page for Forum_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Forum_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Forum_Detail and all its components.
        /// </summary>
        public Forum_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaForum_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaForum_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaForum_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaForum_Detail(PanoramaForum_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaForum_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IForum_Forum>();
				AddHomeAppBarButton();
				...
				((IViewModels.IForum_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
