...
{
    /// <summary>
    /// Phone application page for Facebook_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Facebook_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Facebook_Detail and all its components.
        /// </summary>
        public Facebook_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaFacebook_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaFacebook_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaFacebook_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaFacebook_Detail(PanoramaFacebook_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaFacebook_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IFacebook_Facebook>();
				AddHomeAppBarButton();
				...
				((IViewModels.IFacebook_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
