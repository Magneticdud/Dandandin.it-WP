...
namespace WPAppStudio.Repositories
{
    ...
    public class Forum_Forum : IForum_Forum 
    {
        ...
        public Forum_Forum(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://www.dandandin.it/Forums/RSS.aspx?pageid=2&mid=3), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("Forum_Forum", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("Forum_Forum");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://www.dandandin.it/Forums/RSS.aspx?pageid=2&mid=3), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
