...
namespace WPAppStudio.Repositories
{
    ...
    public class Web_RSS : IWeb_RSS 
    {
        ...
        public Web_RSS(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
