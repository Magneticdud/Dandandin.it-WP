...
namespace WPAppStudio.Repositories
{
    ...
    public class YouTube_YouTube : IYouTube_YouTube 
    {
        ...
        /// <summary>
        /// Retrieves the data from Youtube (channel: Magneticdud ), in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        /// <summary>
        /// Refresh the data from Youtube (channel: Magneticdud ), in an observable collection of YouTubeVideo items.
        /// </summary>
        /// <returns>An observable collection of YouTubeVideo items.</returns>
		...
		/// <summary>
        /// Retrieves the data from Youtube (channel: Magneticdud ), filtered by a filter specification, in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        {
			var data = _storageService.Load<EntitiesBase.YouTubeVideo[]>("YouTube_YouTube");
