...
namespace WPAppStudio.Repositories
{
    ...
    public class Facebook_Facebook : IFacebook_Facebook 
    {
        ...
        public Facebook_Facebook(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("Facebook_Facebook", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("Facebook_Facebook");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (https://www.facebook.com/feeds/page.php?format=rss20&id=125252329504), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
